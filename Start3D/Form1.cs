...
namespace Start3D
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                if (Scene.MouseAboveSolid(new PointF(e.Location.X - xOffset, -(e.Location.Y - yOffset)),true))
                {
            ...
            //if (e.Button == MouseButtons.Left && (ModifierKeys == Keys.None) && !creatingCylinder)
            //{
            //    if (Scene.MouseAbovePoint(new PointF(e.Location.X - xOffset, -(e.Location.Y - yOffset))))
            //    {
